...
const PerfumeHeader = () => {
  return (
    <section className="px-8 md:px-12 lg:px-24 flex flex-col lg:flex-row lg:items-center gap-8 h-fit bg-gray-100 py-8">
      <div className="flex flex-col w-full h-fit gap-4 lg:w-1/2">
        <span className="text-red-600 font-semibold">HOT DEAL</span>
        <h1 className="text-2xl font-inknut font-bold">
        ...
        <button className="w-full font-medium lg:w-fit px-4 py-2 bg-yellow-500 rounded shadow-lg cursor-pointer hover:bg-yellow-300 active:bg-white active:ring-offset-2 active:ring-2 active:ring-yellow-500 active:text-yellow-500">
          Buy now
        </button>
      </div>
      <img
